...
const Footer = () => {
  ...
  return (
    <footer id="footer" className="relative bg-green-500">
      ...
      <div className="relative z-10 flex flex-col text-white mx-auto px-4">
        <div className="flex flex-col lg:flex-row w-full justify-between gap-[20px] sm:px-[20px] py-[20px]">
          ...
          <div className="basis-[20%]">
            ...
            <ul className="list-none">
              <li className="address1 flex items-center text-white"><i className="fa-solid fa-location-dot mr-2"></i>49/1, Dr Subbarayan Rd, <br /> I Agraharam, Salem,<br /> Tamil Nadu - 636001, India.</li>
